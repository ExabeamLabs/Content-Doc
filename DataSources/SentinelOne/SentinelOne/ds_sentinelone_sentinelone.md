...
|    [Physical Security](../../../UseCases/uc_physical_security.md)    |  failed-physical-access<br> ↳[sentinelone-process-alert](Ps/pC_sentineloneprocessalert.md)<br> | T1078 - Valid Accounts<br> | [<ul><li>5 Rules</li></ul><ul><li>3 Models</li></ul>](RM/r_m_sentinelone_sentinelone_Physical_Security.md)    |
