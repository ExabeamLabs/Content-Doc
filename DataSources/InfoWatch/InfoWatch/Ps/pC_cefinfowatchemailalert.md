...
Name = cef-infowatch-email-alert
  ...
  Fields = [
    ...
    """\Wsntdom=({sender}[^@=]{1,2000}?@({external_domain_sender}[^@]{1,2000}?))(\s{1,100}[\w\.]{1,2000}=|\s{0,100}$)""",
    """\Wsuser=({user}.+?)(\s{1,100}[\w\.]{1,2000}=|\s{0,100}$)""",
    """\Wduser=({recipients}({recipient}[^;@=]{1,2000}@({external_domain_recipient}[^;\s]{1,2000})).*?)(\s{1,100}[\w\.]{1,2000}=|\s{0,100}$)""",
