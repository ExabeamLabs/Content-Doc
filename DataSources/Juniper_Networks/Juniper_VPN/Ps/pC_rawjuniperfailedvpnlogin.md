...
Name = raw-juniper-failed-vpn-login
  ...
  Fields = [
    ...
    """PulseSecure:[^\[]{1,2000}\[({src_ip}[A-Fa-f.\d:]{1,2000})\]\s{1,100}([\w\s]{1,2000}?::)?(({domain}[^\s\\]{1,2000})\\{1,20})?(\?|(?:({user_email}[^@\s]{1,2000}@[^@\s\(]{1,2000})|('\+)?(\)|\w{1,5}://[^\(]{1,2000}|\$\{.+\}\w{0,100}|\.|(({=domain}[^\/\(]{1,2000})\/{1,20})?(\.|({user}[^\n]{1,2000}?)))(\=|\')?(\([\d\*]{1,100}\))?(\+')?))\(({realm}[^\(]{0,2000})?\)\[([^\]]{0,2000})\]\s{0,100}\-\s{0,100}({failure_reason}[^\(]{1,2000}?)?\s{0,100}\("""
  ]
