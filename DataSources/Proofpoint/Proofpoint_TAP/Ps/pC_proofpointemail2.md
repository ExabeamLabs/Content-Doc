...
Name = proofpoint-email-2
   ...
   Fields = [
      ...
      """'from':\s{0,100}\[?'[^@]{0,2000}?({sender}[^'@"\s=<\[\]]{1,2000}@({external_domain_sender}[^'@"\s=>\[\]]{1,2000}))""",
      """'subject':\s{0,100}\['\s{0,100}({subject}.+?)\s{0,100}'""",
      """'envelope':\s{0,100}\{.*'rcpts':\s{0,100}\['({recipients}({recipient}[^'@]{1,2000}@({external_domain_recipient}[^']{1,2000})).*?)'\]""",
