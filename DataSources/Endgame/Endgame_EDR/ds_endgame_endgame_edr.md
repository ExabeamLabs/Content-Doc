...
|    [Data Leak](../../../UseCases/uc_data_leak.md)    |  print-activity<br> ↳[endgame-edr-security-alert](Ps/pC_endgameedrsecurityalert.md)<br> | T1052 - Exfiltration Over Physical Medium<br> | [<ul><li>4 Rules</li></ul>](RM/r_m_endgame_endgame_edr_Data_Leak.md)    |
