...
|    [Data Leak](../../../UseCases/uc_data_leak.md)    |  print-activity<br> ↳[lexmark-print-activity](Ps/pC_lexmarkprintactivity.md)<br> | T1052 - Exfiltration Over Physical Medium<br> | [<ul><li>4 Rules</li></ul>](RM/r_m_lexmark_lexmark_Data_Leak.md)    |
