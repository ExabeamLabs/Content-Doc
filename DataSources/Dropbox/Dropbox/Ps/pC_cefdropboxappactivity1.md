...
Name = cef-dropbox-app-activity-1
  Conditions = [ """destinationServiceName =Dropbox""", """.tag""", """"access_method"""",  """"file_operations"}""" ]
  Fields = ${DropboxParserTemplates.cef-dropbox-activity.Fields}[
    """"assets":\s{0,100}\[[^\]]{0,2000}?"display_name":\s{0,100}"({file_name}[^",]{1,2000})"""",
    """"assets":\s{0,100}\[[^\]]{0,2000}?"contextual":\s{0,100}"({file_path}[^",]{1,2000})""""
  ]
