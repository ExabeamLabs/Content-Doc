...
Name = bro-web-activity
  ...
  Fields = [
    ...
    """"_system_name":"({host}[^"]+)""",
    """"host":"[^"]*?({top_domain}[^"\\\/\.]+(?:\.(?:com|net|info|edu|org|gov|co|jp|ru|de|ir|it|in|fr|info|pl|nl|es|gr|cz|eu|tv|me|jp|ca|cn|uk|my|cc|id|us|nz|biz|club|io|gg|fi|au|st|tw|asia|sg|ie|li|za))+)\s{0,100}"""",
