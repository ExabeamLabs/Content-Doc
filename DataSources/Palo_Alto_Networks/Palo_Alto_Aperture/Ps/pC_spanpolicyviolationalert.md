...
Name = s-pan-policyviolation-alert
    ...
    Fields = [
      ...
      """\Witem_type\s{0,100}=\s{0,100}"user"(\s{0,100}\w+\s{0,100}=\s{0,100}"[^"]{0,2000}")*\s{0,100}item_name\s{0,100}=\s{0,100}"(Unknown|({user_email}[^"]{1,2000}))"""",
      """\Witem_name\s{0,100}=\s{0,100}"(Unknown|({user_email}[^"]{1,2000}))"(\s{0,100}\w+\s{0,100}=\s{0,100}"[^"]{0,2000}")*\s{0,100}item_type\s{0,100}=\s{0,100}"user"""",
      ...
      """"item_type":"user".*?"item_name":"(Unknown|({user_email}[^"]{1,2000}))""",
      """"item_name":"(Unknown|({user_email}[^"]{1,2000}))".*?"item_type":"user"""",
      """"cloud_app_instance":"({alert_type}[^"]{1,2000})""",
      """"action_taken":"({additional_info}[^"]{1,2000})""",
      """"item_creator":"(|({item_creator}[^"]{1,2000}))"""",
      """"item_creator_email":"(|Unknown|({user_email}[^"]{1,2000}))"""",
