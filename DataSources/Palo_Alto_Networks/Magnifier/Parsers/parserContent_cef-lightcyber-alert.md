...
Name = cef-lightcyber-alert
  ...
  Fields = [
    ...
    """\|LightCyber\|Magna\|[^|]{1,2000}?\|[^|]{1,2000}?\|({alert_name}.+?)\|""",
    """\|LightCyber\|Magna\|[^|]{1,2000}?\|[^|]{1,2000}?\|[^|]{1,2000}?\|({alert_severity}.+?)\|""",
    ...
    """\|LightCyber\|Magna\|[^|]{1,2000}?\|[^|]{1,2000}?\|({alert_type}.+?)\|.+?\s{1,100}cs2=({alert_name}.+?)\s{1,100}fileHash="""
  ]
