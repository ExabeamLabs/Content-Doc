...
```Java
{
Name = gcp-general-activity
   DataType = "gcp-general-activity"
   TimeFormat = """yyyy-MM-dd'T'HH:mm:ss.SSSSSSZ"""
   Conditions = [ """googleapis.com""", """methodName""" ] 
}     

${SAPParserTemplates.sap-login-activity}{
  Name = sap-account-password-change
  DataType = "password-change"
  Conditions = [ """CEF:""", """|SECUDE|C-Bus|""", """dvchost=""", """|DUZ|""", """login/password_change_for_SSO""" ]
