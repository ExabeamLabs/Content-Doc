...
Name = u-googledrive-file-activity
  ...
  Fields = [
    ...
    ""","events":[^=]{0,2000}?"name":"doc_id","value":"({file_id}[^"]{1,2000})"[^=]{0,2000}?"name":"doc_type","value":"(unknown|({file_type}[^"]{1,2000}))"[^=]{0,2000}?"name":"doc_title","value":"\s{0,100}({file_name}[^"]{1,2000}?)\s{0,100}"[^=]{0,2000}?"name":"visibility","value":"({privileges}[^"]{1,2000})"[^=]{0,2000}?"name":"owner","value":"\s{0,100}({file_owner}[^"]{1,2000}?)\s{0,100}"\},((\{[^}]{1,2000}\},\{[^\}]{0,2000}?"value":"({additional_info}[^"]{1,2000}))?)""" 
  ]
