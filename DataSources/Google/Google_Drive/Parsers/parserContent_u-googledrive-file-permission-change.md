...
Name = u-googledrive-file-permission-change
  ...
  Fields = [
    ...
    """cs6=[^=]+?"events":[^\}\]]*?"name":"({accesses}[^"]{1,2000})[^=]*?"type":"acl_change"""",
    """:"({app}drive)""",
    """"parameters":[^=]{0,2000}?"name":"target_user","value":"(({user_email}[^@",\s]{1,2000}@[^@",\s]{1,2000})|({user}[^@",\s]{1,2000}))"[^=]{0,2000}?"name":"doc_id","value":"({file_id}[^"]{1,2000})"[^=]{0,2000}?"name":"doc_type","value":"((?i)unknown|({file_type}[^"]{1,2000}))"[^=]{0,2000}?"name":"doc_title","value":"({file_name}[^"]{1,2000}?(\.\s{0,100}({file_ext}[a-zA-Z]{1,2000}?))?)\s{0,100}"[^=]{0,2000}?"name":"visibility","value":"({privileges}[^"]{1,2000})"[^=]{0,2000}?"name":"owner","value":"({file_owner}[^"]{1,2000})"""",
  ]
