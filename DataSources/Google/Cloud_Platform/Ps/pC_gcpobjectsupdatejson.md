...
```Java
{
Name = gcp-objectsupdate-json
  DataType = "gcp-storageobject-acl"
  TimeFormat = """yyyy-MM-dd'T'HH:mm:ss.SSSSSSZ"""
  Conditions = [ """googleapis.com""", """"methodName":"storage.objects.update"""", """policyDelta"""]
  Fields = ${GcpParserTemplates.gcp-cloudaudit-json.Fields}[
    """"{1,20}bindingDeltas"{1,20}:\s{0,100}\[\s{0,100}({policy_delta}.+)\s{0,100}\],?[\s\]\
gcp-cloudaudit-json = {
    Vendor = Google
