...
```Java
{
Name = gcp-instancessetmetadata-json
  DataType = "gcp-instance-setmetadata"
  TimeFormat = """yyyy-MM-dd'T'HH:mm:ss.SSSSSSZ"""
  Conditions = [ """googleapis.com""", """"methodName":""", """compute.instances.setMetadata"""" ]
  Fields = ${GcpParserTemplates.gcp-cloudaudit-json.Fields}[
    """"addedMetadataKeys":\s{0,100}\[\s{0,100}({added_keys}[^\\\]\/]{1,2000})""",
    """"modifiedMetadataKeys":\s{0,100}\[\s{0,100}({modified_keys}[^\\\]\/]{1,2000})"""
  ]
