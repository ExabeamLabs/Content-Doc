...
```Java
{
Name = gcp-instancessetmachinetype-json
  DataType = "gcp-instance-setmachinetype"
  TimeFormat = """yyyy-MM-dd'T'HH:mm:ss.SSSSSSZ"""
  Conditions = [ """googleapis.com""", """"methodName":""", """compute.instances.setMachineType"""" ]
  Fields = ${GcpParserTemplates.gcp-cloudaudit-json.Fields}[
    """"machineType":\s{0,100}"({machine_type}[^"\\]*)"""",
  ]
