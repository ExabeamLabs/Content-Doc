...
Name = lastpass-app-activity
  ...
  Fields = [
    ...
    """fname=({file_name}[^=]{1,2000}?)\s{1,200}[\w]{1,2000}=""",
    """filePermission=({accesses}[^=]{1,2000}?)\s{1,200}[\w]{1,2000}=""",
    """duser=({target_user}[^=]{1,2000}?)\s{1,200}[\w]{1,2000}=""",
    """Resource:\s{1,200}({file_type}[^:]{1,2000})\s{1,200}::"""
  ]
