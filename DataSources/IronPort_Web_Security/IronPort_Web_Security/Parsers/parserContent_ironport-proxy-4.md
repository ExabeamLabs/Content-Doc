...
Name = ironport-proxy-4
  ...
  Product = IronPort Web Security
   ...
   Fields = [
     ...
     """Info:\s.*?\s({src_ip}\d+.\d+.\d+.\d+)\s({proxy_action}[^\/]+)\/({result_code}\d+)\s\d+\s({method}[^\s]+)({full_url}.+?\.({top_domain}.*\.(com|net|info|edu|org|gov|co|jp|ru|de|ir|it|in|fr|info|pl|nl|es|gr|cz|eu|tv|me|jp|ca|cn|uk|my|cc|id|us|nz|biz|club|io|gg|fi|au|st|tw|asia|sg|ie|li|za))[^\s]+)""",
