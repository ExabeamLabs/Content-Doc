...
Name = q-box-app-activity
  ...
  Fields = [
    ...
    """[^\w]created_at"{1,20}\s{0,100}:\s{0,100}"{1,20}({time}\d\d\d\d\-\d\d\-\d\dT\d\d:\d\d:\d\d.\d{1,7}Z?)[",\]\}]""",
    ...
    """[^\w]created_by"{1,20}\s{0,100}:\s{0,100}[^\}]{1,2000}?[^\w]login"{1,20}\s{0,100}:\s{0,100}"{1,20}(|({user_email}[^@"]{1,2000}?@(([\.\w+]{1,2000}\.)?({email_domain}[^\.\s"]{1,2000}\.(?:com|net|info|edu|org|gov|co|jp|ru|de|ir|it|in|fr|info|pl|nl|es|gr|cz|eu|tv|me|jp|ca|cn|uk|my|cc|id|us|nz|biz|club|io|gg|fi|au|st|tw|asia|sg|ie|li|za|ch))|[^@"]{1,200}))|({user}[^"\s]{1,2000}))[",\]\}]""",
    ...
    """[^\w]folder_name"{1,20}\s{0,100}:\s{0,100}"{1,20}\s{0,100}({file_name}[^"]{1,2000}?)[",\]\}]""",
    """[^\w]item_name"{1,20}\s{0,100}:\s{0,100}"{1,20}\s{0,100}({file_name}[^"]{1,2000}?)[",\]\}]""",
  ...
  DupFields = [ "accesses->activity", "host->dest_host" ]
