...
Name = vectra-alert-3
  ...
  Fields =[
    ...
    """"{0,20}severity"{0,20}:\s{1,100}({alert_severity}\d{1,100})""",
    """"{0,20}host_name"{0,20}:\s{1,100}"{1,20}({src_host}[^"]{1,2000})""",
    """"{0,20}dd_dst_ip"{0,20}:\s{1,100}"{1,20}({dest_ip}[^"]{1,2000})""",
    """"{0,20}dd_proto"{0,20}:\s{1,100}"{1,20}({protocol}[^"]{1,2000})"{1,20},""",
    """"{0,20}threat"{0,20}:\s{1,100}({threat_id}\d{1,100})"""
  ]
 }
```