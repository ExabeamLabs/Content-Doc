...
|:----:| ---- | ---- | ---- |
| [Compromised Credentials](../../../UseCases/uc_compromised_credentials.md) |  network-alert<br> ↳[cef-hp-print-activity](Ps/pC_cefhpprintactivity.md)<br> ↳[s-hp-print-activity](Ps/pC_shpprintactivity.md)<br> | T1027.005 - Obfuscated Files or Information: Indicator Removal from Tools<br> | [<ul><li>8 Rules</li></ul><ul><li>4 Models</li></ul>](RM/r_m_hp_print_server_Compromised_Credentials.md) |
