...
Name = cisco-wsa-web-activity
  ...
  Fields = [
	...
	"""({top_domain}(?!(?:\d{1,100}\.){3}\d{1,100})[^:\/\.\s]{1,2000}(?i)(?=(?:\.(?:com|net|info|edu|org|gov|co|jp|ru|de|ir|it|in|fr|info|pl|nl|es|gr|cz|eu|tv|me|jp|ca|cn|uk|my|cc|id|us|nz|biz|club|io|gg|fi|au|st|tw|asia|sg|ie|li|za|aero|ai|be|cloud|goog|gt|im|ki|la|market|marketing|mobi|ms|network|ninja|page|pub|report|services|tg|uy))+(\/|:))[^\s\/:]{1,2000})"""
  ]
