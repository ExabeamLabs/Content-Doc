...
Name = cisco-netflow-connection
  ...
  Fields = [
    ...
    """list \S{1,2000} ({outcome}\S{1,2000}) (|({protocol}[^\.:]{1,2000}\s))({src_ip}[a-fA-F\d.:]{1,2000})(|\(({src_port}\d{1,100})\)|\s{0,100}({src_interface}\S{1,2000}))(\s{0,100}->\s{0,100}({dest_ip}[a-fA-F\d.:]{1,2000})(?:\(({dest_port}\d{1,100})\))?)?""",
