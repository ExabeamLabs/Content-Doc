...
|    [Data Leak](../../../UseCases/uc_data_leak.md)    |  print-activity<br> ↳[cisco-asa-connection-built-302013](Ps/pC_ciscoasaconnectionbuilt302013.md)<br> | T1052 - Exfiltration Over Physical Medium<br> | [<ul><li>4 Rules</li></ul>](RM/r_m_cisco_adaptive_security_appliance_Data_Leak.md)    |
