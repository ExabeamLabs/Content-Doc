...
Name = cisco-ftd-connection-teardown
  ...
  Fields = [
    ...
    """\sduration\s{1,100}({duration}\S+)\s{1,100}bytes\s{1,100}({bytes}\d{1,100})(\s{1,100}({reason}[^\(]{1,2000}[^\(\s]))?(\s{1,100}\((({user_email}[^@\)]{1,2000}@[^\.\)]{1,2000}\.[^\)]{1,2000})|({user}[^@\)]{1,2000}]))\))?""",
    """%FTD-.*?\((({domain}[^\\\/]{1,2000})[\\\/]{1,20})?(({user_email}[^@\)]{1,2000}@[^\.\)]{1,2000}\.[^\)]{1,2000})|({user}[^\\\/\)]{1,2000}?))\)"""
  ]
