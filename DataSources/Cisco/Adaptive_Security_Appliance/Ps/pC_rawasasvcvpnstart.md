...
Name = raw-asa-svc-vpn-start
  ...
  Fields = [
    ...
    """User[\s\t]{1,2000}<(({domain}[^\\\/]{1,2000})[\\\/])?(?![^\s]{1,2000}@[^\s]{1,2000})({user}[^>]{1,2000})>[\s\t]{1,2000}IP[\s\t]{1,2000}<({src_ip}[^>]{1,2000})>[\s\t]{1,2000}(?:IPv4[\s\t])?Address[\s\t]{1,2000}<({src_translated_ip}[^>]{1,2000})>"""
