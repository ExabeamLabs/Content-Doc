...
Name = crowdstrike-network-connection
    ...
    Fields = [
      ...
      """"LocalAddressIP4":"(0.0.0.0|({src_ip}[^"]{1,2000}))",("[^"]{1,2000}":"[^"]{1,2000}",){5}"RemotePort":"({dest_port}\d{1,100})",("[^"]{1,2000}":"[^"]{1,2000}",){3,4}"LocalPort":"({src_port}\d{1,100})",("[^"]{1,2000}":"[^"]{1,2000}",){6}"RemoteAddressIP4":"(0.0.0.0|({dest_ip}[^"]{1,2000}))","ConnectionDirection":"({direction}0)"""",
      """"LocalAddressIP6":"(0:0:0:0:0:0:0:0|({src_ip}[^"]{1,2000}))","RemoteAddressIP6":"(0:0:0:0:0:0:0:0|({dest_ip}[^"]{1,2000}))",("[^"]{1,2000}":"[^"]{1,2000}",){3}"RemotePort":"({dest_port}\d{1,100})",("[^"]{1,2000}":"[^"]{1,2000}",){3}"LocalPort":"({src_port}\d{1,100})",("[^"]{1,2000}":"[^"]{1,2000}",){6}"ConnectionDirection":"({direction}0)"""",
