...
Name = cef-okta-app-login-1
  ...
  Fields=[
    ...
    """request"{1,20}:[^\]]{0,2000}?User[^\]]{0,2000}?"{1,20}displayName"{1,20}:\s{0,100}(null|"{1,20}(Okta System|(?:({user_firstname}[^,"]{1,2000}),\s{0,100}({user_lastname}[^"]{1,2000})|((?i)Unknown|RSA-OKTA Admin|AD-OKTA Admin|({user_fullname}[^"]{1,2000}))))")""",
    """"actor"{1,20}[^\]]{0,2000}?"{1,20}type"{1,20}:\s{0,100}"{1,20}User[^\]]{0,2000}?displayName"{1,20}:\s{0,100}(null|"{1,20}(Okta System|Okta Admin|(?:({user_lastname}[^,"]{1,2000}),\s{0,100}({user_firstname}[^"]{1,2000})|((?i)Unknown|RSA-OKTA Admin|AD-OKTA Admin|AD Agent|({user_fullname}[^"]{1,2000})))))""",
    ...
    """request"{1,20}:[^\]]{0,2000}?"{1,20}type"{1,20}:\s{0,100}"{1,20}User"{1,20
