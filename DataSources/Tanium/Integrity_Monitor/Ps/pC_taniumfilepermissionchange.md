...
```Java
{
Name = tanium-file-permission-change
  DataType = "file-permission-change"
  Conditions = [ """ Tanium """, """ Computer-Name ="""", """ Process-Path="""", """ File-Path="""", """Change-Type="FilePermissionChange"""" ]
  Fields = ${TaniumParserTemplates.tanium-file-operations.Fields}[
    """({accesses}FilePermissionChange)"""
  ]
