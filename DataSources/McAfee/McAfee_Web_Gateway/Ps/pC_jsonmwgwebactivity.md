...
Name = json-mwg-web-activity
    ...
    Fields = [
        ...
        """"headUsrAgt":"(?:|({browser}[^"]{1,2000}))"""",
        """"headUsrAgt":"({browser}[\w\-]{1,2000})\/[\d\._]{1,2000}""",
        """"headUsrAgt":"({browser}[^\/";]{1,2000}).+({os}iOS|Android|BlackBerry|Windows Phone|BeOS|(?:W|w)indows|(?:L|l)inux|(?:M|m)acintosh|(?:D|d)arwin)""",
