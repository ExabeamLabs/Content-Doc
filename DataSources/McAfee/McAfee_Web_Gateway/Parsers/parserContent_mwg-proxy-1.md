...
Name = mwg-proxy-1
    ...
    Fields = [
		...
		""""http_method":"(?:|({method}[^"]+))"""",
		""""domain":"(.*?)({top_domain}(?!(?:\d{1,100}\.){3}\d{1,100})[^\.\s]+(?=(?:\.(?:com|net|info|edu|org|gov|co|jp|ru|de|ir|it|in|fr|info|pl|nl|es|gr|cz|eu|tv|me|jp|ca|cn|uk|my|cc|id|us|nz|biz|club|io|gg|fi|au|st|tw|asia|sg|ie|li|za))+(\"|\/))[^"\/]+)""",
                """"url":"(?:|({full_url}[^"]+))"""",
