...
```Java
{
Name = s-digitalguardian-file-read
  Vendor = Digital Guardian
  Product = Digital Guardian Endpoint Protection
  Lms = Splunk
  DataType = "file-read"
  TimeFormat = "MM/dd/yyyy HH:mm:ss a"
  Conditions = ["""Agent_UTC_Time=""","""Was_Destination_Removable="False"""", """Destination_Drive_Type="None"""",  """Operation="Application Data Exchange"""" ]
  Fields = [
    ...
    """Source_File="({src_file_name}[^"]{1,2000}?)\s{0,100}"""",
    """Destination_Directory="(\?:\\|({file_parent}[^"]{1,2000}))"""",
    """Destination_File="({file_name}[^"]{1,2000}?)\s{0,100}"""",
