...
```Java
{
Name = digital-guardian-send-mail-1
  Product = Digital Guardian Network DLP
  DataType = "dlp-alert"
  Conditions = [ """dg_""", """"_time":""", """"Event Display Name":"""", """"Send Mail"""" ]
  Fields = ${DGParserTemplates.digitalguardian-file-operation.Fields}[
    """"Email Subject":"({subject}[^"]{1,2000})""",
