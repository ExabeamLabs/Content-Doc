...
```Java
{
Name = leef-beyondtrust-app-activity-10
Vendor = BeyondTrust
Product = BeyondInsight
Lms = Direct
DataType = "app-activity"
TimeFormat = "MMM dd yyyy HH:mm:ss"
Conditions = [ """cat=Change""", """LEEF:""", """|BeyondTrust|BeyondInsight|""", """EventDesc=Success""", """EventName =Managed""" ]
Fields = [
...
"""Result=({outcome}[^\s]{1,2000})\s{0,100}"""
]
