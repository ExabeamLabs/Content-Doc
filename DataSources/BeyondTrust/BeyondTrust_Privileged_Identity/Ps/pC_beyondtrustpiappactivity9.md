...
```Java
{
Name = beyondtrust-pi-app-activity-9
  Conditions = [ """EVENT_ID_SHARED_CREDENTIAL_LIST_REMOVED_ACCOUNT""", """2059""", """sEventID""", """dwBasicEventType""", """sOriginatingApplicationName""", """dwAppSpecificEventID""", """Privileged Identity""" ]
