...
```Java
{
Name = skyformation-cloudflare-waf-4
  Vendor = Cloudflare
  ...
  Fields = [
    ...
    """"SecurityAction":"(unknown|({proxy_action}[^"]{1,2000}))""",
    """"SecurityRuleID":"({event_code}[^"]{1,2000})""",
    """"SecurityRuleDescription":"({additional_info}[^"]{1,2000})""",
