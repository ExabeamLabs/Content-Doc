...
Name = cef-carbonblack-file-alert
  ...
  Fields = [
    ...
    """\|Carbon Black\|Protection\|([^|]{0,2000}?\|){2}({alert_name}[^\|]{1,2000})\|""",
    """\|Carbon Black\|Protection\|([^|]{0,2000}?\|){2}({accesses}[^\|]{1,2000})\|""",
    """\|Carbon Black\|Protection\|([^|]{0,2000}?\|){2}({accesses}[^\|]{1,2000}?)(\s{0,100}\([^|]{1,2000})?\|""",
