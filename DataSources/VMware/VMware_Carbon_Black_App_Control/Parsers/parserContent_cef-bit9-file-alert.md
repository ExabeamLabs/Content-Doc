...
Name = cef-bit9-file-alert
  ...
  Fields = [
    ...
    """\|Bit9\|Security Platform\|([^|]{0,2000}?\|){2}({alert_name}[^\|]{1,2000})\|""",
    """\|Bit9\|Security Platform\|([^|]{0,2000}?\|){2}({accesses}[^\|]{1,2000})\|""",
    """\|Bit9\|Security Platform\|([^|]{0,2000}?\|){2}({accesses}[^\|]{1,2000}?)(\s{0,100}\([^|]{1,2000})?\|""",
