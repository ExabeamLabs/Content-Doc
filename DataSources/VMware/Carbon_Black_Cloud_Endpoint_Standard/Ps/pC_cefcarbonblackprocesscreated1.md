...
```Java
{
Name = cef-carbonblack-process-created-1
  DataType = "process-created"
  IsHVF = true
  Conditions = [ """threatIndicators""" , """ invoked """, """"eventType":"CREATE_PROCESS"""", """destinationServiceName =CB Defense""", """dproc=create process event""" ]
