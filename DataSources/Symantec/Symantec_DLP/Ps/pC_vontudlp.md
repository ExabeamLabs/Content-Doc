...
Name = vontu-dlp
    ...
    Fields = [
      ...
      """\WBlocked:\s{1,100}({outcome}[^,]{1,2000}?(, User:[^:]{1,2000}?)?)(,\s{0,100}\w+:|\s{0,100}$)""",
      ...
      """\WSubject:\s{1,100}({subject}[^,]{1,2000}?)(,\s{0,100}\w+:|\s{0,100}$)""",
      """\WAttachment_Filename:\s{1,100}({attachments}[^,]{1,2000}?)(,\s{0,100}\w+:|\s{0,100}$)"""
    ]
