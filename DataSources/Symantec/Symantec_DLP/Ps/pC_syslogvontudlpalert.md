...
Name = syslog-vontu-dlp-alert
    ...
    """exabeam_host=({host}\S+)""",
      ...
      """[\s,]recipients="{1,20}\s{0,100}({recipients}(?:({external_address}[^\s"@,]{1,2000}@[^\s@",]{1,2000}?))(?:\s{0,100},\s{0,100}[^\s"@,]{1,2000}@[^\s@",]{1,2000}?\s{0,100}?)*)\s{0,100}"{0,20},""",
      """[\s,]recipients="{1,20}\s{0,100}({full_url}(\w+:\/+)?({web_domain}[^\\\/]{1,2000})[^\s]{1,2000})(?::|"|\/)""",
