...
Name = r-syslog-vontu-dlp
  ...
  Fields = [
    ...
    """Vontu Incident:\s{1,100}(([^\^]|\^[^\^])+?\^\^){7}(N\/A|({recipients}({external_address}(?!\w+:\/\/)[^@\s]{1,2000}@\S+?)(,[^@\s]{1,2000}@\S+?)*))\^\^""",
    """Vontu Incident:\s{1,100}(([^\^]|\^[^\^])+?\^\^){7}(N\/A|({target}([^\^]|\^[^\^])+?))\^\^""",
    """Vontu Incident:\s{1,100}(([^\^]|\^[^\^])+?\^\^){7}(N\/A|\s{0,100}({full_url}(\w+:\/+)?({web_domain}[^\\\/]{1,2000})[^\s]{1,2000}))(\/\S+?)?\^\^""",
