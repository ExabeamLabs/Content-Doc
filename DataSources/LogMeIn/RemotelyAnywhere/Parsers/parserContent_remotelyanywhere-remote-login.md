...
Name = remotelyanywhere-remote-login
  ...
  Fields = [
    ...
    """\sDOMAIN_NAME:\s{1,100}"{1,20}(unknown|null|({domain}[^"]+))"{1,20}\s""",
    """\sEVENT_TYPE_D:\s{1,100}"{1,20}({event_name}[^"]+)"{1,20}\s""",
    """\sEVENT_SEVERITY_D:\s{1,100}"{1,20}({alert_severity}[^"]+)"{1,20}\s""",
    """\sEVENT_PRIORITY:\s{1,100}"{1,20}({priority}[^"]+)"{1,20}\s""",
    """\sPOLICY_NAME:\s{1,100}"{1,20}({policy}[^"]+)"{1,20}\s""",
    """\sPROCESS_NAME:\s{1,100}"{1,20}(unknown|null|({process}[^"]+))"{1,20}\s""",
    """\sUSER_NAME:\s{1,100}"{1,20}(unknown|null|({user}[^"]+))"{1,20}\s"""
  ]
