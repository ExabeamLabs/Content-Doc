...
|:--------------------------------------:| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- | --------------------------------------------------------------------------------------------------------------- |
| [Other](../../../UseCases/uc_other.md) |  account-password-reset<br> ↳ [specops-account-password-reset](Parsers/parserContent_specops-account-password-reset.md)<br><br> account-unlocked<br> ↳ [specops-account-unlocked](Parsers/parserContent_specops-account-unlocked.md)<br> | T1078 - Valid Accounts<br> | [<ul><li>1 Rules</li></ul><ul><li>1 Models</li></ul>](Rules_Models/r_m_specops_specops_password_reset_Other.md) |
