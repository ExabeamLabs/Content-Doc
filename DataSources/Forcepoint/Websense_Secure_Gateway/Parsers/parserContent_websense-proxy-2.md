...
Name = websense-proxy-2
  ...
  Fields = [
    ...
    """\Wurl="?(?:-|({protocol}\w+))\\*:\/+""",
    """\Wurl="?(?:-|(\w+\\*:\/+)?[^\/"=]+)({uri_path}\/[^\/][^?\s"]*)""",
    """\Wurl="?[^\?\s"=]*({uri_query}\?[^\s"]*)"?,?(\s{1,100}\w+=|\s{0,100}$)""",
    """\Wurl="?(?:[^:]+\\*:\/+)?({web_domain}[^\/:\s"]+)""",
    """\Wurl="?(\w+\\*:\/+)?([^\/]*?)({top_domain}(?!(?:\d{1,100}\.){3}\d{1,100})[^\.\s\/:"]+(?:\.(?:com|net|info|edu|org|gov|co|jp|ru|de|ir|it|in|fr|info|pl|nl|es|gr|cz|eu|tv|me|jp|ca|cn|uk|my|cc|id|us|nz|biz|club|io|gg|fi|au|st|tw|asia|sg|ie|li|za|br))+)(\s|\/|$|:|")""",
