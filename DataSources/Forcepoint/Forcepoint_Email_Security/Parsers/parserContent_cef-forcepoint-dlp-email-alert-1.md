...
Name = cef-forcepoint-dlp-email-alert-1
  ...
  Fields = [
    ...
    """from=({sender}[^@]{1,2000}?@({external_domain_sender}[^\s>]{1,2000}?))(>)?(\s|\s{0,100}$)""",
    """\Wfrom=\s{0,100}([^<]{1,2000}<)?(<)?({sender}[^@=>]{1,2000}?@({external_domain_sender}[^@=>]{1,2000}?))(>)?(\s{1,100}\w+=|\s{0,100}$)""",
    """to=({recipient}[^@]{1,2000}?@({external_domain_recipient}[^\s>]{1,2000}?))(>)?(\s|\s{0,100}$)""",
    """\Wto=\s{0,100}([^<]{1,2000}<)?(<)?({recipient}[^@=>]{1,2000}?@({external_domain_recipient}[^@=>]{1,2000}?))(>)?(\s{1,100}\w+=|\s{0,100}$)""",
