...
Name = cef-forcepoint-dlp-email-alert-1
  ...
  Fields = [
    ...
    """suser=({sender}[^@=]{1,2000}?@[^\s>]{1,2000}?)(>)?(\s|\s{0,100}$)""",
    """\Wsuser=\s{0,100}([^<]{1,2000}<)?(<)?({sender}[^@=>]{1,2000}?@[^@=>]{1,2000}?)(>)?(\s{1,100}\w+=|\s{0,100}$)""",
    """duser=({recipient}[^@=]{1,2000}?@[^\s>]{1,2000}?)(>)?(\s|\s{0,100}$)""",
    """\Wduser=\s{0,100}([^<]{1,2000}<)?(<)?({recipient}[^@=>]{1,2000}?@[^@=>]{1,2000}?)(>)?(\s{1,100}\w+=|\s{0,100}$)""",
