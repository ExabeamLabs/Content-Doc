...
Name = cef-netskope-file-operation-6
  ...
  Conditions = [ """"type":"""", """destinationServiceName =Netskope""", """"activity":"Edit"""", """"object_type":"File"""" ]
  Fields = ${NetskopeParserTemplates.cef-netskope-activity.Fields} [
  """"object":\s{0,100}"+(\s{1,100}"|(\s{0,100}(Unknown Unknown|unknown|Unknown|null|(?:<[^>=]{1,2000}>[^"]{1,2000}?)|({file_path}(({file_parent}[^"]{0,2000}?)[\\\/]{1,20})?({file_name}[^"\\\/]{1,2000}(\.({file_ext}[^"\\\/]{1,2000})?))))\s{0,100}"))"""
  ]
...
cef-netskope-activity = {
  ...
  Fields = [
    ...
    """"object":\s{0,100}"(\s{1,100}"|(\s{0,100}(Unknown Unknown|unknown|Unknown|null|(?:<[^>=]{1,2000}>[^"]{1,2000}?)|({object}[^"]{1,2000}?))\s{0,100}"))""",
    ...
    """"file_type":\s{0,100}"(Unknown|({file_type}[^"]{1,2000}))"""",
