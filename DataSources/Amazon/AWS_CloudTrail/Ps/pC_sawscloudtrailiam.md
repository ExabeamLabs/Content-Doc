...
Name = s-aws-cloudtrail-iam
 ...
 Fields = [
     ...
     """"userIdentity[^@]{1,2000}?type\\?":\s{0,100}\\?"({identity_type}[^"]{1,2000}?)\\?"""",
     """"sessionIssuer[^@]{1,2000}?type\\?":\s{0,100}\\"({user_type}[^"]{1,2000}?)\\?"""",
     ...
     """"{1,20}errorCode"{1,20}\s{0,100}:\s{0,100}"{1,20}?(|success|({failure_code}[^"]{1,2000}?))"{1,20}\s{0,100}[,\]\}]""",
