...
```Java
{
Name = aws-getobject-json
  Vendor = Amazon
  Product = AWS CloudTrail
  Lms = Direct
  DataType = "aws-storageobject-read"
  TimeFormat = """yyyy-MM-dd'T'HH:mm:ss.SSSSSSZ"""
  Conditions = [ """AwsApiCall""", """"eventName":"GetObject"""" ] 
  Fields = ${AwsParserTemplates.aws-cloudtrail-json.Fields}[
    ...
    """"{1,20}resources.+?Object.+?(?:ARN|arn)\\?":\s{0,100}\\?"({file_arn}[^"]{1,2000}?)\\?"""",
    """"{1,20}resources.+?Bucket.+?(?:ARN|arn)\\?":\s{0,100}\\?"({bucket_arn}[^"]{1,2000}?)\\?"""",
  ]
