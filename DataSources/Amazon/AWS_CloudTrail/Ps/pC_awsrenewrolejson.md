...
Name = aws-renewrole-json
  ...
  Fields = ${AwsParserTemplates.aws-cloudtrail-json.Fields}[
    """"{1,20}userIdentity.+?AssumedRole.+?arn\\?":\s{0,100}\\?"[^"]{1,2000}?\/({user}[^"\/]{1,2000}?)\\?"{1,20}""",
    """"{1,20}additionalEventData.+?RoleRenewed\\?"{1,20}:\s{0,100}\\?"({role_arn}[^"]{1,2000}\/({role}[^\\"]{1,2000}))\\?"{1,20}""",
    """"{1,20}additionalEventData.+?RedirectTo\\?"{1,20}:\s{0,100}\\?"({full_url}[^"]{1,2000})\\?"{1,20}""",
  ]
