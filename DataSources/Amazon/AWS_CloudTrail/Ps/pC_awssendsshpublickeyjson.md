...
```Java
{
Name = aws-sendsshpublickey-json
  Vendor = Amazon
  Product = AWS CloudTrail
  Lms = Direct
  DataType = "aws-instance-login"
  TimeFormat = """yyyy-MM-dd'T'HH:mm:ss.SSSSSSZ"""
  Conditions = [ """AwsApiCall""", """"eventName":"SendSSHPublicKey"""" ] 
  Fields = ${AwsParserTemplates.aws-cloudtrail-json.Fields}[
    """"{1,20}requestParameters.+?instanceOSUser\\?":\s{0,100}\\?"({os_user}[^"]{1,2000}?)\\?"""",
