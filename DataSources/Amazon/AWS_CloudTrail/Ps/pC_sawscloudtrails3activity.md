...
Name = s-aws-cloudtrail-s3-activity
 ...
 Fields = [
         ...
         """"sessionIssuer[^@]{1,2000}?[^$]{1,2000}?type\\?":\s{0,100}\\?"({user_type}[^"]{1,2000}?)\\?"""",
         ...
         """"{1,20}errorCode"{1,20}\s{0,100}:\s{0,100}"{1,20}?(|success|({failure_code}[^"].+?))"{1,20}\s{0,100}[,\]\}]""",
         """"{1,20}errorMessage"{1,20}\s{0,100}:\s{0,100}"{1,20}?(|({failure_reason}[^"].+?))"{1,20}\s{0,100}[,\]\}]""",
         """"{1,20}(?i)accountId"{1,20}\s{0,100}:\s{0,100}"{1,20}?(|({account_id}[^"].+?))"{1,20}\s{0,100}[,\]\}]""",
