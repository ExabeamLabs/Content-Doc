...
Name = s-aws-cloudtrail-s3-activity
 ...
 Fields = [ 
         ...
         """"userIdentity\\?".{1,2000}?"arn\\?"\s{0,100}:\s{0,100}\\?"?arn:aws:iam::[^\/"]{1,2000}\/(({user_email}[^\@"]{1,2000}@[^\."]{1,2000}\.[^"]{1,2000}?)|({user}[^"]{1,2000}?))[\\]{0,20}""""
         """"userIdentity\\?".{1,2000}?"arn\\?"\s{0,100}:\s{0,100}\\?"?arn:aws:sts::\d{1,100}:assumed-role\/([^\/"]{1,2000}\/)(({user_email}[^\@"]{1,2000}@[^\."]{1,2000}\.[^"]{1,2000}?)|({user}[^"]{1,2000}?))[\\]{0,20}""""
