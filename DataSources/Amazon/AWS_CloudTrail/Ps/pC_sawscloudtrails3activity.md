...
Name = s-aws-cloudtrail-s3-activity
 ...
 Fields = [
         ...
         """"userIdentity\\?"[^@]{1,2000}?\\?"{1,20}[^$]{1,2000}?arn\\?"{1,20}\s{0,100}:\s{0,100}\\?"{1,20}?(|arn:aws:sts::\d{1,100}:([^"]{1,2000}\/){1,256}({identity}(?!\-\d{1,100})[^\/]{1,256}?))\\?"{1,20}\s{0,100}[,\]\}]""",
         ...
         """"userName"{1,20}\s{0,100}:\s{0,100}"{1,20}?(|({user}[^"].+?))"{1,20}\s{0,100}[,\]\}]""",
