...
```Java
{
Name = cef-sophos-security-alert-43
  DataType = "security-alert"
  Conditions = [ """CEF:""", """"type":"Event::Endpoint::DownloadReputationUserAuthorised"""", """"group":"DOWNLOAD_REPUTATION"""", """"severity":"""", """destinationServiceName =Sophos Central""" ]
