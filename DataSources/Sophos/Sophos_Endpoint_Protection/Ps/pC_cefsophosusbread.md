...
```Java
{
Name = cef-sophos-usb-read
  DataType = "usb-activity"
  Conditions = [ """CEF:""", """"type":"Event::Endpoint::Device::ReadOnly"""", """"group":"PERIPHERALS"""", """"severity":"""", """destinationServiceName =Sophos Central""" ]
  Fields=${SophosParserTemplates.cef-sophos-security-alert-1.Fields}[
    """"type":"({alert_name}[^"]{1,2000})"""",
    """"group":"({alert_type}[^"]{1,2000})"""",
    """"name":"({additional_info}({activity}[^:]{1,2000})[^"]{1,2000})""""
  ]
  DupFields = [ "alert_name->event_name", "host->src_host" ]
