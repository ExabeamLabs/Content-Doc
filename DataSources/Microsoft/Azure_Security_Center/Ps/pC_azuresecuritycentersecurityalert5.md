...
```Java
{
Name = azure-security-center-security-alert-5
Vendor = Microsoft
...
""""userPrincipalName":"((?i)null|(({user_email}[^\@"]{1,2000}\@([^\."]{1,2000}\.){0,20}\w{1,2000})(\@[\w\-.]{1,2000})?|(({user_fullname}[^\s"]{1,2000}\s{1,20}[^"]{1,2000})|({user}[^"]{1,2000}))))""""
