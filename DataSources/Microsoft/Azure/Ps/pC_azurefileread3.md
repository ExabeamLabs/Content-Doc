...
```Java
{
Name = azure-file-read-3
  Product = Azure
  DataType = "file-read"
  Conditions= [ """destinationServiceName =Azure""", """"_ResourceId":"""", """"CorrelationId":"""", """dproc=Log Analytics OMS Workspace""", """"OperationName":"KeyListVersions"""" ]
