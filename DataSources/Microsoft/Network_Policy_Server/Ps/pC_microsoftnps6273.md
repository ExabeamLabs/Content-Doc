...
Name = microsoft-nps-6273
  ...
  Fields = [
    ...
    """({event_code}6273)""",
    """'SubjectUserName'>(?:({user_type}host)/)?(({domain}[^\\<]{1,2000})\\+)?(({user_email}[^@\s\\\<\/]{1,2000}@[^@\s\\\<\/]{1,2000})|(({user}[\w-]{1,2000})(\.[\w.]{1,2000})?)|({user_fullname}[\w,-]{1,2000}?))<""",
    """'SubjectDomainName'>(?:-|({domain}[^\s\<]{1,2000}))""",
    """'FullyQualifiedSubjectUserName'>(({domain}[^\\\/<]{1,2000})\\+)?(?:-|({user_email}[^@\s\\\<\/]{1,2000}@[^@\s\\\<\/]{1,2000})|(({user}[\w-]{1,2000})(\.[\w.]{1,2000})?)|({user_fullname}[\w,-]{1,2000}?))<""",
    """'FullyQualifiedSubjectUserName'>(({domain}[^\\\/<]{1,2000})\/+)?({user_group}[^\s\<\/]{1,2000})(\/([^\/]{1,2000}))?\/(?:-|({user_email}[^@\s\\\<\/]{1,2000}@[^@\s\\\<\/]{1,2000})|(({user}[\w-]{1,2000})(\.[\w.]{1,2000})?)|({user_fullname}[^\s\/<]{1,2000}\s{1,100}[^\s<\/]{1,2000}))<""", 
