...
Name = microsoft-nps-6273
  ...
  Fields = [
    ...
    """({event_code}6273)""",
    """'SubjectUserName'>(?:({user_type}host)/)?(({domain}[^\\<]{1,2000})\\+)?(({user_email}[^@\s\\\<\/]{1,2000}@[^@\s\\\<\/]{1,2000})|(({user}[\w-]{1,2000})(\.[\w.]{1,2000})?))<""",
    """'SubjectDomainName'>(?:-|({domain}[^\s\<]{1,2000}))""",
    """'FullyQualifiedSubjectUserName'>(({domain}[^\\\/<]{1,2000})\\+)?(?:-|({user_email}[^@\s\\\<\/]{1,2000}@[^@\s\\\<\/]{1,2000})|(({user}[\w-]{1,2000})(\.[\w.]{1,2000})?))<""",
