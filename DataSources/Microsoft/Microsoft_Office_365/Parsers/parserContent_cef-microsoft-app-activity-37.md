...
Name = cef-microsoft-app-activity-37
  ...
  Fields = ${MSParserTemplates.cef-microsoft-app-activity.Fields}[
    ...
    """\Wext_result=(|({outcome}.+?))\s{1,100}(\w+=|$)""",
    """\Wext_targetResources_0__modifiedProperties_1__newValue=(|(\[|")({object}.+?)(\]|"))\s{1,100}(\w+=|$)""",
    """\Wext_targetResources_0__displayName=(|({target}.+?))\s{1,100}(\w+=|$)""",
    """\WdestinationServiceName=(|({event_subtype}.+?))\s{1,100}(\w+=|$)""",
    """\Wext_category=(|({additional_info}.+?))\s{1,100}(\w+=|$)""",
