...
```Java
{
Name = microsoft-app-activity-5
  Conditions= [ """"src-application-name":"Office 365"""", """"event-name":"authz-group-unassigned"""", """initiatedBy":""", """"src-endpoint":"Graph Directory Audit logs"""", """"category":"GroupManagement"""" ]
