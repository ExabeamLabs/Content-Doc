...
```Java
{
Name = microsoft-app-activity-6
  Conditions= [ """"src-application-name":"Office 365"""", """"event-name":"user-added"""", """initiatedBy":""", """"src-endpoint":"Graph Directory Audit logs"""", """"category":"UserManagement"""" ]
