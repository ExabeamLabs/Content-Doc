...
```Java
{
Name = microsoft-app-activity-12
  Conditions= [ """"src-application-name":"Office 365"""", """"event-name":"user-suspended"""", """initiatedBy":""", """"src-endpoint":"Graph Directory Audit logs"""", """"category":"UserManagement"""" ]
