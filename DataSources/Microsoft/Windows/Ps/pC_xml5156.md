...
Name = xml-5156
  ...
  Fields = [
    ...
    """<RenderingInfo[^$]{1,2000}?<Task>({activity_type}[^<>]{1,2000})</Task>[^$]{0,2000}?</RenderingInfo>""",
    """<Computer>({src_host}[^<>]{1,2000})</Computer>[^$]{1,2000}?Direction:\s{0,100}({direction}Outbound)""",
    """<Computer>({dest_host}[^<>]{1,2000})</Computer>[^$]{1,2000}?Direction:\s{0,100}({direction}Inbound)""",
