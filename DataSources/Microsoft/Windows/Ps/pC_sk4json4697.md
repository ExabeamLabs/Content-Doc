...
Name = sk4-json-4697
  ...
  Fields = ${WinParserTemplates.json-windows-events-1.Fields}[
    ...
    """"{1,20}ServiceName"{1,20}:"{1,20}({service_name}[^"]{1,2000})""",
    """"{1,20}ServiceFileName"{1,20}:"{1,20}({process}({directory}[^\s]{1,2000})\\({process_name}[^"]{1,2000}))""",
    """"{1,20}ServiceStartType"{1,20}:"{1,20}({service_start_type}[^"]{1,2000})"""
  ]
