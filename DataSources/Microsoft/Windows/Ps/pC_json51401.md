...
Name = json-5140-1
  ...
  Conditions = [ """"Activity":"5140 - A network share object was accessed."""", """"EventID":"5140"""", """"EventSourceName":"Microsoft-Windows-Security-Auditing"""", """"Type":"SecurityEvent"""" ]
  Fields = ${WinParserTemplates.json-windows-events-3.Fields}[
    ...
    """"RelativeTargetName"{1,20}:"{1,20}({f_parent}(?:[^"]{1,2000})?[\\\/])?({file_name}[^\\:"]{1,2000}?(\.\s{0,100}({file_ext}[^"\\.\s]{1,2000}?))?)"""",
