...
Name = sk4-json-5137
  ...
  Conditions = [""""event_id":5137""", """"provider_name":"Microsoft-Windows-Security-Auditing""", """A directory service object was created""", """ cs6="""]
  Fields = ${WinParserTemplates.json-windows-events-1.Fields}[
    ...
    """"{1,20}DSType"{1,20}:"{1,20}({service_type}[^"]{1,2000})""",
    """"{1,20}OpCorrelationID"{1,20}:"{1,20}({correlation_id}[^"]{1,2000})""",
    """"{1,20}ObjectDN"{1,20}:"{1,20}({object_dn}[^"]{1,2000})"""
  ]
