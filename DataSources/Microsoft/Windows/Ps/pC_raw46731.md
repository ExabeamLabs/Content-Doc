...
Name = raw-4673-1
  ...
  Fields = [
    ...
    """({outcome}(?i)(((audit|success|failure)( |_)(success|audit|failure))|information))\s{0,100}(\s|\t|,|#\d{1,100}|<[^>]{1,2000}>)\s{0,100}(4673|({host}[^=<>]{1,2000}?))\s{0,100}(\s|\t|,|#\d{1,100}|<[^>]{1,2000}>)\s{0,100}""",
    """({event_code}4673)""",
