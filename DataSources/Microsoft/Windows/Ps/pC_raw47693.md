...
Name = raw-4769-3
    ...
    Fields = [
      ...
      """({event_code}4769)""",
      """Account Name(:|=)\s{0,100}(\w+\/({src_host}[^@\s]{1,2000})(@({domain}[\w._\-]{1,2000}))?|({user}[^@:\s;]{1,2000})(@({=domain}[\w._\-]{1,2000}))?)[\s;]{0,2000}Account Domain(:|=)""",
      """Account Domain(:|=)\s{0,100}({domain}[^:=]{1,2000}?)[\s;]{0,2000}Logon GUID(:|=)""",
