...
Name = ad-audit-alert
  ...
  Fields = [
    ...
    """\WALERT_PROFILE\s{0,100}=\s{0,100}({alert_type}[^=]{1,2000}?)\s{0,100}(\]|([\w_]{1,2000})\s{0,100}=)""",
    """\WSEVERITY\s{0,100}=\s{0,100}({alert_severity}\d{1,100})""",
    """\WFORMAT_MESSAGE\s{0,100}=\s{0,100}.+?\sby\s{1,100}'?(({domain}[^'\\]{1,2000})\\)?({user}[^\s\\']{1,2000})'?""",
    """\WFORMAT_MESSAGE = User '?({target_user}[^'\s]{1,2000})'?[^=]{1,2000}?was (created|deleted) by""",
    ...
    """\WFORMAT_MESSAGE\s{0,100}=.+?\son\s{1,100}'?(?:({dest_ip}[A-Fa-f:\d.]{1,2000})|({dest_host}[^\s'\(\)]{1,2000}))'?\s{1,100}""",
    ...
    """\WFORMAT_MESSAGE\s{0,100}=\s{0,100}({additional_info}.+?)\s{0,100}(\]|([\w_]{1,2000})\s{1,100}=)"""
  ]
