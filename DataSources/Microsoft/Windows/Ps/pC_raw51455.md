...
Name = raw-5145-5
    ...
    Fields = [
      ...
      """Share Name:\s{0,100}((\\)[rnt])*(?:\\\\\*\\)?\s{0,100}({share_name}.+?)((\\)[rnt])*\s{0,100}Share Path:""",
      """Share Path:\s{0,100}((\\)[rnt])*(?:[\\\?]{1,2000})?(?:\s{0,100}|\s{0,100}({share_path}\s{0,100}(({d_parent}.+?)\\)?\s{0,100}(|({d_name}[^\\]{0,2000}?)))\\?)((\\)[rnt])*\s{0,100}Relative Target Name:""",
      """Relative Target Name:\s{0,100}((\\)[rnt])*\\?(?:\s{0,100}|(?:({f_parent}.+?)\\)?\s{0,100}(|({file_name}[^\\:\/]{1,2000}?(?:\.({file_ext}[^\.\s\\]{1,2000}?))?))(?:\\HEAD|:.+?|\\|\s|((\\)[rnt])*)\s{0,100})Access Request Information:""",
