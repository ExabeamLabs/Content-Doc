...
Name = raw-4625-1
    ...
    Fields = [
      ...
      """(\s|;)Computer(Name)?="?({host}[^\s;"]{1,2000})(\s|"|;)""",
      """({event_code}4625)""",
      ...
      """\s{0,100}Logon Failed(:|=).+?Account Name(:|=)\s{0,100}({user}[^\s@;]{1,2000})@({domain}\w{1,2000})\s{1,2000}Account Domain:""",
      """\s{0,100}Logon Failed(:|=).+?Account Name(:|=)\s{0,100}({user_email}[^\s@;]{1,2000}?@[^\.]{1,2000}\.[^@:]{1,2000}?)[\s;]{0,2000}Account Domain(:|=)""",
