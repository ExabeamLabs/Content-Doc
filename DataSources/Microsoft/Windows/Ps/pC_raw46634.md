...
Name = raw-4663-4
    ...
    Fields = [
      ...
      """exabeam_host=(::ffff:)?({host}(({dest_ip}(\d{1,3}\.){3}\d{1,3})|({dest_host}[\w.\-]{1,2000})))""",
      """(?i)(((audit|success)( |_)(success|audit))|information)[\s,](::ffff:)?({host}(({dest_ip}(\d{1,3}\.){3}\d{1,3})|({dest_host}[\w\-.]{1,2000}))).*Subject:""",
      """({event_code}4663)""",
