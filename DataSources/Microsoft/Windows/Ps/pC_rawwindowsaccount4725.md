...
Name = raw-windows-account-4725
    ...
    Fields = [
      ...
      """Subject:.+?Security ID:\s{0,100}({user_sid}[^:]{1,2000}?)\s{1,100}Account Name:""",
      """Subject:.+?Account Name:\s{0,100}({user}[^:]{1,2000}?)\s{1,100}Account Domain:\s{0,100}({domain}[^:]{1,2000}?)\s{1,100}Logon ID""",
      """Logon ID:\s{0,100}({logon_id}[^\s]{1,2000})""",
      """Target Account.+?Security ID:\s{0,100}(%\{)?({target_user_sid}[^:]{1,2000}?)\}?\s{1,100}Account Name:\s{0,100}({target_user}[^:]{1,2000}?)\s{1,100}Account Domain""",
