...
```Java
{
Name = mcas-security-alert-3
  Product = Cloud App Security (MCAS)
  Conditions = [ """"category":"MCAS_ALERT_ANUBIS_DETECTION_REPEATED_ACTIVITY_FAILED_LOGIN"""", """vendor":"Microsoft"""", """"sourcetype":"GraphSecurityAlert"""", """provider":"MCAS"""" ]
