...
```Java
{
Name = azure-snapshots-write
  Vendor = Microsoft
  Product = Microsoft Azure
  Lms = Direct
  DataType = "azure-snapshot-write"
  TimeFormat = """yyyy-MM-dd'T'HH:mm:ss.SSSSSSZ"""
  Conditions = [ """value":"Microsoft.Compute/snapshots/write""" ]
  Fields = ${MSParserTemplates.azure-activity-json.Fields}[
    ...
    """"{1,20}osType\\?"{1,20}:\s{0,100}\\?"{1,20}({os_type}[^"]{1,2000})\\"{1,20}""",
