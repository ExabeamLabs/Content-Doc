...
Name = o365-dlp-alert
  ...
  Fields =[
    ...
    """"Subject"{1,20}:\s{0,100}"{1,20}({subject}.+?)\s{0,100}"{1,20},"{1,20}To"{1,20}:""",
    """"RuleName"{1,20}:\s{0,100}"{1,20}({alert_name}[^",]{1,2000})"""",
    """"Severity"{1,20}:\s{0,100}"{1,20}({alert_severity}[^"]{1,2000})"""",
    """"Actions"{1,20}:\s{0,100}\["{1,20}({action}[^"]{1,2000})"{1,20}\]""",
    """"RecipientCount"{1,20}:\s{0,100}({recipient_count}\d{1,100})""",  
