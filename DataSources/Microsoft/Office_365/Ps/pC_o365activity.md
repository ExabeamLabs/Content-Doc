...
Name = o365-activity
  ...
  Fields = [
    ...
    """"UserId\\{0,20}"{1,20}:[\s\\]{0,2000}"{1,20}(({user_email}[^"\\@]{1,2000}?@({email_domain}([\.\w+]{1,2000}\.){0,256}[^\.\\\s"]{1,2000}?\.[^\\\s"\.>]{1,2000})>?\s{0,100})|(Not Available|(({domain}[^"\\\/]{1,2000})[\\\/])?(Unknown|((\w+?_)?(\w+-)?\w+-\w+-\w+-\w+)|({user_sid}[^"\\\/@\s]{1,2000}?))))",""",
