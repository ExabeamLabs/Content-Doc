...
Name = cef-o365-security-alert
  ...
  Fields = [
    ...
    """"{1,20}userAgent"{1,20},"{1,20}Value"{1,20}:"{1,20}({user_agent}[^"]{1,2000}?)\s{0,100}"""",
    ...
    """"{1,20}activity":"({action}[^"]{1,2000})""",
    """"{1,20}additionalInfo":"\[\{\\"{1,20}({more_info}[^]]{1,2000}?)\s{0,100}\\"{0,20}\}\]""",
    """flexString1=({activity}[^=]{1,2000}?)\s{0,100}\w+=""",
