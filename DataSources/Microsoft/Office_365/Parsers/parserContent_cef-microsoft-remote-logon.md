...
cef-azure-app-activity-1 = {
  ...
  Fields = [
    ...
    """\Wduser=(anonymous|({user_email}[^@=]+@({email_domain}[^@=]+?))|({user}.+?))(\s+\w+=|\s*$)""",
    """\Wsuser=(anonymous|({user_email}[^@=]+@({email_domain}[^@=]+?))|({user}.+?))(\s+\w+=|\s*$)""",
    """\Wsuid=(anonymous|({user_email}[^@=]+@({email_domain}[^@=]+?))|({user}.+?))(\s+\w+=|\s*$)""",
