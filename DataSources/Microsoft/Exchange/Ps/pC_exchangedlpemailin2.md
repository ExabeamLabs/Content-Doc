...
Name = exchange-dlp-email-in-2
  ...
  Fields = [
    ...
    """({direction}Incoming)""",
    """,({recipients}({recipient}[^\s@;,"]{1,2000}@({external_domain}[^\s@;,"]{1,2000}))[^,]{0,2000}?),(?:[^",]{1,2000}?,|,)({bytes}\d{1,100}),({num_recipients}\d{1,100}),(?:"(?:[^"]|"")+",|[^",]{1,2000}?,|,){6}Incoming,""",
    """,\s{0,100}({subject}[^,]{0,2000}?)\s{0,100},(?:[^",]{1,2000}?,|,){3}Incoming,""",
    ""","\s{0,100}({subject}[^"]{1,2000}?)\s{0,100}",(?:[^",]{1,2000}?,|,){3}Incoming,""",
    """,(MicrosoftExchange[^,]{1,2000}?|({external_address}[^\s,;@"']{1,2000}@({external_domain}[^\s;,"'@]{1,2000}))),(?:<>|({return_path}[^,]{1,2000}?)),(?:[^",]{1,2000}?,|,)Incoming,"""
  ]
