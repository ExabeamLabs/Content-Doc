...
Name = raw-windows-account-4720
  ...
  Fields = [ 
      ...
      """Account Name:\s{1,100}({user}.+?)\s{1,100}Account Domain:\s{1,100}({domain}[^\s]{1,2000}).+?Logon ID:\s{1,100}({logon_id}[^\s]{1,2000}).+?Account Name:\s{1,100}({account_name}.+?)\s{1,100}Account Domain:\s{1,100}({account_domain}[^\s]{1,2000})\s{1,100}Attributes""",
      """Subject:\s{1,100}Security ID:\s{1,100}({user_sid}[^\s]{1,2000}).+?Account Name:\s{1,100}({user}.+?)\s{1,100}Account Domain:\s{1,100}({domain}[^\s]{1,2000}).+?Logon ID:\s{1,100}({logon_id}[^\s]{1,2000})""",
