...
Name = json-4673-1
  ...
  Fields = ${WinParserTemplates.json-windows-events-1.Fields}[
    ...
    """"PrivilegeList"{1,20}:"{1,20}({privileges}[^"]{1,2000})""",
    """"ObjectServer"{1,20}:"{1,20}({object_server}[^"]{1,2000})""",
    """"ProcessName"{1,20}:"{1,20}({process}({directory}(?:[^";]{1,2000})?[\\\/])?({process_name}[^\\\/";]{1,2000}?))"""",
