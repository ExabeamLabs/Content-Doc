...
Name = json-4769-2
  ...
  Fields = ${WinParserTemplates.json-windows-events-2.Fields}[
    ...
    """ServiceName\\?"{1,20}:\\?"{1,20}({dest_host}[^\s\\]{1,2000})""",
    """IpAddress\\?"{1,20}:\\?"{1,20}(::[\w]{1,2000}:)?({src_ip}[\da-fA-F.:]{1,2000})\\?"""",
    """Status\\?"{1,20}:\\?"{1,20}({result_code}[^\s\\]{1,2000})""",
    """TicketOptions\\?"{1,20}:\\?"{1,20}({ticket_options}[^\s\\]{1,2000})""",
