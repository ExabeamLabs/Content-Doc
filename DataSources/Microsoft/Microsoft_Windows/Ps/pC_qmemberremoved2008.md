...
Name = q-member-removed-2008
  ...
  Fields = [
    ...
    """Member:\s{1,100}Security ID:\s{1,100}({account_id}(?=[^\\]{1,2000}\\)({sid_domain}[^\\]{1,2000})\\({sid_user}[^\s]{1,2000})|(?:[^\s]{1,2000}))\s{1,100}Account Name:\s{1,100}({account_dn}CN=.+?,({account_ou}OU.+?DC=[\w-]{1,2000}))?[\w-]{0,2000}\s{1,100}Group:\s{1,100}Security ID:\s{1,100}({group_id}[^\s]{1,2000}).+?\s{1,100}(Group|Account) Name:\s{1,100}({group_name}[^\s]{1,2000})?.+?\s{1,100}(Group|Account) Domain:\s{1,100}({group_domain}[^\s]{1,2000})""",
  ]
