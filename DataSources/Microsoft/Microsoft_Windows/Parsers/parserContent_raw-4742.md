...
Name = raw-4742
  ...
  Fields = [
    ...
    """({event_code}4742)""",
    """Subject:.+?\sAccount Name:\s{0,100}(|-|({user}[^:]{1,2000}?))\s{0,100}Account Domain:\s{0,100}(|-|({domain}[^:]{1,2000}?))\s{0,100}Logon ID:\s{0,100}(|-|({logon_id}[^:]{1,2000}?))\s{0,100}Computer Account That Was Changed:.*?\sAccount Name:\s{0,100}(|-|({target_user}[^:]{1,2000}?))\s{0,100}Account Domain:\s{0,100}(|-|({object_dn}[^:]{1,2000}?))\s{0,100}Changed Attributes:""",
