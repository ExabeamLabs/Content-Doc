...
Name = json-5136
  ...
  Fields = [
    ...
    """"{1,20}Hostname"{1,20}:"{1,20}({host}[^"]+)"{1,20}""",
    """"{1,20}EventType"{1,20}:"{1,20}({outcome}[^"]+)"{1,20}""",
    """"{1,20}Severity"{1,20}:"{1,20}({severity_type}[^"]+)"{1,20}""",
    """"{1,20}EventID"{1,20}:({event_code}\d{1,100})""",
    """"{1,20}SourceName"{1,20}:"{1,20}({log_source}[^"]+)"{1,20}""",
    """""{1,20}ProviderGuid"{1,20}:"{1,20}\{({process_guid}[^}]+)""",
    """"{1,20}ActivityID"{1,20}:"{1,20}\{({activity_id}[^}]+)""",
    """"{1,20}ProcessID"{1,20}:({process_id}\d{1,100})"""
    """"{1,20}Message"{1,20}:"{1,20}({aditional_info}[^"]+)""",
    """"{1,20}Category"{1,20}:"{1,20}({category}[^"]+)"""
