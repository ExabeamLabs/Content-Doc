...
Name = s-windows-5157
  ...
  Fields = [
    ...
    """({event_code}5157)""",
    """\s{0,100}Computer(Name)?=({host}[^\s]+)\s{0,100}""",
    """\s{0,100}Process ID:\s{0,100}({pid}[^\s]+)\s{0,100}""",
    """\s{0,100}Source Address:\s{0,100}({src_ip}[a-fA-F:\d.]+)\s{0,100}""",
    """\s{0,100}Source Port:\s{0,100}({src_port}\d{1,100})\s{0,100}""",
    """\s{0,100}Destination Address:\s{0,100}({dest_ip}[a-fA-F:\d.]+)\s{0,100}""", 
    """\s{0,100}Destination Port:\s{0,100}({dest_port}\d{1,100})\s{0,100}""",
    """\s{0,100}Protocol:\s{0,100}({protocol}\d{1,100})\s{0,100}""",
    """\s{0,100}Direction:\s{0,100}({direction}[^\s]+)\s{0,100}""",
    """\s{0,100}Layer Name:\s{0,100}({layer_name}[^\s]+)\s{0,100}""", 
