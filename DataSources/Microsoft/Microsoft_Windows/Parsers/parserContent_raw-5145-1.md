...
Name = raw-5145-1
    ...
    Fields = [
      ...
      """Object Type:\s{0,100}((\\)[rnt])*({file_type}.+?)\s{0,100}((\\)[rnt])*\s{0,100}Source Address:""",
      """Source Address:\s{0,100}((\\)[rnt])*(::1|({src_ip}[A-Fa-f:\d.]{1,2000}?))((\\)[rnt])*\s{0,100}Source Port:""",
      """Share Name:\s{0,100}((\\)[rnt])*(?:\\\\\*\\)?({share_name}.+?)\s{0,100}((\\)[rnt])*\s{0,100}Share Path:""",
      """Share Path:\s{0,100}((\\)[rnt])*(?:[\\\?]{1,2000})?(?:\s{0,100}|({share_path}(({d_parent}.+?)\\)?(|({d_name}[^\\]{0,2000}?)))\\?)\s{0,100}((\\)[rnt])*\s{0,100}Relative Target Name:""",
