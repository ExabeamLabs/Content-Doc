...
Name = wazuh-4624
  ...
  Conditions = [ """"data.id":"4624"""", """"type":"wazuh-alerts"""", """"decoder.parent":"windows""""  ]
    ...
    """Nouvelle ouverture de session.*?Nom du compte\\u00A0:\s{0,100}({user}[^\s]+)\s{0,100}Domaine du compte\\u00A0:\s{0,100}({domain}[^\s]+)\s{0,100}ID d\\u2019ouverture de session\\u00A0:"""
    """Nom du processus\\u00A0:\s{0,100}(?:-|({process}[\w:\\.\-]+))"""
    ...
    """ID d\\u2019ouverture de session\\u00A0:\s{0,100}({logon_id}[^\s]+)\s{0,100}GUID d\\u2019ouverture de session\\u00A0:"""
    """Nouvelle ouverture de session\\u00A0:\s{0,100}ID de s\\u00E9curit\\u00E9\\u00A0:\s{0,100}({user_sid}[^\s]+)\s"""
    ]
}
