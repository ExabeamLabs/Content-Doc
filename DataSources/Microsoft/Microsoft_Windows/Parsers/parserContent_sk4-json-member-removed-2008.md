...
Name = sk4-json-member-removed-2008
  ...
  Fields = ${WinParserTemplates.json-windows-events-1.Fields}[
    ...
    """"{1,20}group"{1,20}:.+?name"{1,20}:"{1,20}({group_name}[^"]+)""",
    """"{1,20}group"{1,20}:.+?domain"{1,20}:"{1,20}({group_domain}[^"]+)""",
    """"{1,20}MemberSid"{1,20}:"{1,20}({account_id}[^"]+)""",
    """"{1,20}MemberName"{1,20}:"{1,20}CN\\=({account_id}[^,"]+)""",
    """"{1,20}MemberName"{1,20}:"{1,20}CN\\=({account_dn}[^,"]+)""",
  ]
}
