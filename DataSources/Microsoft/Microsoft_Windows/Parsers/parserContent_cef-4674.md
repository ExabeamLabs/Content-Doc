...
Name = cef-4674
        ...
        Fields = [
          """({event_name}An operation was attempted on a privileged object)""",
            ...
            """\sdproc=({process}(({directory}.+?)({process_name}[^\\\/]+?)))(\s{1,100}\S+=|\s{0,100}$)""",
            """Object_\,Server=({object_server}.+?)(\s{1,100}[^\s]+=|\s{0,100}$)""",
            """\sduid=({login_id}[^\s]+)""",
            """Desired_\,Access=({accesses}[^\d]+?)(\s{1,100}[^\s]+=|\s{0,100}$)"""
            """\sdpriv=({privileges}.+?)(\s{1,100}[^\s]+=|\s{0,100}$)""",
        ]
