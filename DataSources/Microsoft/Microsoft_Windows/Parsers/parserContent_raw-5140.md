...
Name = raw-5140
    ...
    Fields = [
      ...
      """\sComputer=\s{0,100}(::ffff:)?({host}[^\s]*)""",
      """Computer=\s{0,100}(::ffff:)?"({host}[\w\-.]+)"""",
      ...
      """Share Path:\s{0,100}((\\)[rnt])*(?:\\+\?+)?(?:\s{0,100}|({share_path}(({d_parent}[^"]+?)\\)?(|({d_name}[^\\]+?)))\\?)((\\)[rnt])*\s{0,100}Access Request Information:""",
