...
Name = raw-5145-4
    ...
    Conditions = ["""A network share object was checked to see whether client can be granted desired access""", """Account Name:""", "Microsoft-Windows-Security-Auditing", "Hostname"]
    Fields = [
