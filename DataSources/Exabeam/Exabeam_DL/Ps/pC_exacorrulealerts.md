...
Name = exa-cor-rule-alerts
  ...
  Fields = [
    ...
    """(?:\W|")src_ip"{0,20}(:|=)"{0,20}\s{0,100}({src_ip}[a-fA-F:\d.]{1,2000})\s{0,100}(?:\||")""",
    """(?:\W|")dest_ip"{0,20}(:|=)"{0,20}\s{0,100}({dest_ip}[a-fA-F:\d.]{1,2000})\s{0,100}(?:\||")""",
    ...
    """exa_rule_description(:|=)"{0,20}({top_reasons}[^"\|]{1,2000}?)\s{0,100}(?:\||")""",
    """exa_risk_score"{0,20}(:|=)"{0,20}\s{0,100}({risk_score}[^"|]{1,2000}?)\s{0,100}(?:\||")"""
    """(?:\W|")original_doc_message"{0,20}(=|:)"{0,20}\s{0,100}({rule_description}[^"|]{1,2000}?)\s{0,100}(?:\||")""",
  ]
  SOAR {
    IncidentType = "ueba"
