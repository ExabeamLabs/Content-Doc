...
|:----:| ---- | ---- | ---- |
| [Abnormal Authentication & Access](../../../UseCases/uc_abnormal_authentication_&_access.md) |  failed-app-login<br> ↳[cef-ruid-auth-success](Ps/pC_cefruidauthsuccess.md)<br> | T1133 - External Remote Services<br>    | [<ul><li>3 Rules</li></ul>](RM/r_m_ruid_ruid_Abnormal_Authentication_&_Access.md) |
