...
Name = q-tippingpoint-sms-alert-3
  ...
  Fields = ${TippingPointParserTemplates.tippingpoint-sms-alert-template.Fields} [
    """00000001-0001-0001-0001-00000\d{1,100}\s{1,100}.+?\s{1,100}\d{1,100}\s{1,100}({protocol}udp)""",
    """00000001-0001-0001-0001-00000\d{1,100}\s{1,100}.+?\s{1,100}\d{1,100}\s{1,100}udp(\s{1,100}[^\s]{1,2000}){4}\s{1,100}({hit_cnt}\d{1,100})\s{1,100}""",
    """00000001-0001-0001-0001-00000\d{1,100}\s{1,100}.+?\s{1,100}\d{1,100}\s{1,100}udp(\s{1,100}[^\s]{1,2000}){5}\s{1,100}({src_zone_name}[^\s]{1,2000})\s{1,100}({dest_zone_name}[^\s]{1,2000})""",
    """00000001-0001-0001-0001-00000\d{1,100}\s{1,100}.+?\s{1,100}\d{1,100}\s{1,100}udp(\s{1,100}[^\s]{1,2000}){8}\s{1,100}({vlan_id}\d{1,100})""",
    """00000001-0001-0001-0001-00000\d{1,100}\s{1,100}.+?\s{1,100}\d{1,100}\s{1,100}udp(\s{1,100}[^\s]{1,2000}){9}\s{1,100}({host}[^\s]{1,2000})""",
    """00000001-0001-0001-0001-00000\d{1,100}\s{1,100}.+?\s{1,100}\d{1,100}\s{1,100}udp(\s{1,100}[^\s]{1,2000}){11}\s{1,100}({time}\d{1,100})""",
    """00000001-0001-0001-0001-00000\d{1,100}\s{1,100}.+?\s{1,100}\d{1,100}\s{1,100}udp(\s{1,100}[^\s]{1,2000}){12}\s{1,100}({alert_id}\d{1,100})"""  
  ]
