...
Name = bluecoat-proxy-v2
  ...
  Fields = [
    ...
    """\W(sc|cs)-status="?(-|({result_code}.+?))\s*("|\||$|\t|\s+[\w\-\(\)]+=)""",
    """\Wcs-method="?(-|({method}.+?))\s*("|\||$|\t|\s+[\w\-\(\)]+=)""",
    """\W(sc|rs)-bytes="?(-|({bytes_out}.+?))\s*("|\||$|\t|\s+[\w\-\(\)]+=)""",
    """\Wcs-bytes="?(-|({bytes_in}.+?))\s*("|\||$|\t|\s+[\w\-\(\)]+=)""",
    ...
    """\W(sc-)?filter-category="?(-|({category}.+?))\s*("|\||$|\t|\s+[\w\-\(\)]+=)""",
    """\Wcs-categories="?(-|({category}.+?))"?\s*("|\||$|\t|;|\s+[\w\-\(\)]+=)""",
    """\Wcs-categories="?(-|({categories}.+?))"?\s*("|\||$|\t|\s+[\w\-\(\)]+=)""",
