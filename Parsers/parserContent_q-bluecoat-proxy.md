...
Name = q-bluecoat-proxy
  ...
  Fields = [
    ...
    """\sCONNECT\s+(- )?tcp\s+[^\s]*?({top_domain}[^\s.]+(?:\.(?:com|net|info|edu|org|gov|co|jp|ru|de|ir|it|in|fr|info|pl|nl|es|gr|cz|eu|tv|me|jp|ca|cn|uk|my|cc|id|us|nz|biz|club|io|gg|fi|au|st|tw|asia|sg|ie|li|za|tech|vn|goog|ai))+)\s+""",
