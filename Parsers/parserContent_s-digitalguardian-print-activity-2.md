...
${DGParserTemplates.splunk-digitalguardian-usb-insert} {
...
${DGParserTemplates.splunk-digitalguardian-local-logon} {
...
${DGParserTemplates.splunk-digitalguardian-app-login} {
...
${DGParserTemplates.leef-digitalguardian-file-operation} {
  Name = leef-digitalguardian-file-write-2
  Conditions = [ """LEEF:""", """|Digital Guardian|Digital Guardian|""", """DigitalGuardian-Events""", """|File Move|""" ]
}
